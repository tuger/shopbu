...
type IProps = {
  flashSaleRequests: FlashSaleRequestsPaginator['data'] | null | undefined;
  paginatorInfo: FlashSaleRequestsPaginator['paginatorInfo'] | null;
...
const FlashSaleRequestLists = ({
  ...
  const columns = [
...

    {
      ...
      align: alignRight,
      width: 150,
      render: (id: string, record: FlashSaleRequests) => (
        <>
          <ActionButtons
            id={id}
    ...
    <>
      <div className="mb-6 overflow-hidden rounded shadow">
        <Table
          ...
          data={flashSaleRequests as FlashSaleRequestsPaginator['data']}
          rowKey="id"
          scroll={{ x: 1000 }}
        />
      </div>
