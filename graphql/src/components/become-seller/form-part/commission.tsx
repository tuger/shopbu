    ...
    <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
      ...
      <Card className="w-full sm:w-8/12 md:w-2/3">
        <Input
          ...
          error={t((errors as any)?.page_options?.commissionTitle?.message!)}
          variant="outline"
          className="mb-5"
          required
        />
        <TextArea
          ...
          error={t(
            (errors as any)?.page_options?.commissionDescription?.message,
          )}
          className="mb-5"
          required
        />
        ...
        {Boolean(isMultiCommissionRate) ? (
          <>
            ...
            >
              {fields?.map((item: any & { id: string }, index: number) => {
                let error =
                  (errors as any)?.commissions?.[index]?.image?.message ||
                  (errors as any)?.commissions?.[index]?.level?.message ||
                  (errors as any)?.commissions?.[index]?.sub_level?.message ||
                  (errors as any)?.commissions?.[index]?.description?.message ||
                  (errors as any)?.commissions?.[index]?.min_balance?.message ||
                  (errors as any)?.commissions?.[index]?.max_balance?.message ||
                  (errors as any)?.commissions?.[index]?.commission?.message;
                return (
                  <div
                    ...
                    >
                      <div className="space-y-5 sm:col-span-4">
                        ...
                        <FileInput
                          ...
                          required
                          error={t(
                            (errors as any)?.commissions?.[index]?.image
                              ?.message,
                          )}
                        ...
                        <Input
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.level
                              ?.message,
                          )}
                        />
                        <Input
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.sub_level
                              ?.message,
                          )}
                        />
                        <TextArea
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.description
                              ?.message,
                          )}
                        />
                        <Input
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.min_balance
                              ?.message,
                          )}
                        />
                        <Input
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.max_balance
                              ?.message,
                          )}
                        />
                        <Input
                          ...
                          error={t(
                            (errors as any)?.commissions?.[index]?.commission
                              ?.message,
                          )}
                        />
                      </div>
          ...
          <>
            <TextArea
              ...
              error={t(
                (errors as any)?.page_options?.defaultCommissionDetails
                  ?.message,
              )}
              required
              className="mb-5"
            ...
            <Input
              ...
              error={t(
                (errors as any)?.page_options?.defaultCommissionRate?.message,
              )}
            />
          </>
        )}
