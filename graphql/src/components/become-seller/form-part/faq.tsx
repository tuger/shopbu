    ...
    <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
      ...
      <Card className="w-full sm:w-8/12 md:w-2/3">
        <Input
          ...
          error={t((errors as any)?.page_options?.faqTitle?.message)}
          variant="outline"
          className="mb-5"
          required
        />
        <TextArea
          ...
          error={t((errors as any)?.page_options?.faqDescription?.message)}
          className="mb-5"
          required
        />
        <div>
          {fields?.map(
            (
              ...
              let error =
                (errors as any)?.page_options?.faqItems?.[index]?.title
                  ?.message ||
                (errors as any)?.page_options?.faqItems?.[index]?.description
                  ?.message;
                  ...
                  >
                    <div className="grid grid-cols-1 gap-5 sm:col-span-4">
                      <Input
                        ...
                        required
                        error={t(
                          (errors as any)?.page_options?.faqItems?.[index]
                            ?.title?.message,
                        )}
                      />
                      <RichTextEditor
          ...
          {(errors as any)?.page_options?.faqItems?.message ||
          (errors as any)?.page_options?.faqItems?.root?.message ? (
            <Alert
              message={t(
                (errors as any)?.page_options?.faqItems?.root?.message ||
                  (errors as any)?.page_options?.faqItems?.message,
