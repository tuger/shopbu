    ...
    <div className="flex flex-wrap pb-8 my-5 border-b border-dashed border-border-base sm:my-8">
      ...
      <Card className="w-full sm:w-8/12 md:w-2/3">
        <Input
          ...
          error={t((errors as any)?.page_options?.dashboard?.title?.message)}
          variant="outline"
          className="mb-5"
          required
        />
        <TextArea
          ...
          error={t(
            (errors as any)?.page_options?.dashboard?.description?.message,
          )}
          className="mb-5"
          required
        />
        <Input
          ...
          error={t(
            (errors as any)?.page_options?.dashboard?.buttonName?.message,
          )}
          variant="outline"
          className="mb-5"
        />
        <Input
          ...
          error={t(
            (errors as any)?.page_options?.dashboard?.buttonLink?.message,
          )}
          variant="outline"
          className="mb-5"
        />
        <Input
          ...
          error={t(
            (errors as any)?.page_options?.dashboard?.button2Name?.message,
          )}
          variant="outline"
          className="mb-5"
        />
        <Input
          ...
          error={t(
            (errors as any)?.page_options?.dashboard?.button2Link?.message,
          )}
          variant="outline"
          className="mb-5"
        />
        <FileInput
          ...
          required
          label="Image"
          error={t((errors as any)?.page_options?.dashboard?.image?.message)}
